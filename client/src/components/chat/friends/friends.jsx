  ...
  render() {
    return (
        <div className="friends">
            ...
            <FriendsItem userNick="Dana Medina" userLastMessage="In an ideal world that sandwitch" userLastMessageTime="10:08" userAvatar="http://eliteadmin.themedesigner.in/demos/bt4/assets/images/users/1.jpg" />
        </div>
    );
  }
}
